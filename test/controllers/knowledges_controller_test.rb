...
class KnowledgesControllerTest < ActionController::TestCase
  ...
  test "should create knowledge" do
    assert_difference('Knowledge.count') do
      post :create, knowledge: { description: @knowledge.description, status: @knowledge.status, title: @knowledge.title }
    end
  ...
  test "should update knowledge" do
    patch :update, id: @knowledge, knowledge: { description: @knowledge.description, status: @knowledge.status, title: @knowledge.title }
    assert_redirected_to knowledge_path(assigns(:knowledge))
  end
